        ...
        <FadeIn delay={0.1}>
          <form onSubmit={handleSubmit} className="text-left space-y-4 mb-8" noValidate>
            ...
            <button
              type="submit"
              disabled={sending}
              className="btn-hover spider-tingle inline-flex items-center justify-center px-8 py-3 bg-accent text-white text-sm font-medium rounded-xl hover:opacity-90 transition-opacity min-h-[44px] min-w-[44px] disabled:opacity-50"
            >
        ...
        <FadeIn delay={0.15}>
          <div className="flex items-center justify-center gap-6 mb-8">
            <a
              ...
              className="flex items-center gap-2 text-text-2 hover:text-text-1 transition-all duration-200 hover:scale-105 min-h-[44px] min-w-[44px] justify-center spider-tingle"
            >
              <Mail size={20} />
